...
public abstract class RamlTypeInfoBase extends TypeInfoBase {
  private RamlTypeBase _owner;
  ...
  public RamlTypeInfoBase(RamlTypeBase owner) {
    _owner = owner;
  ...
  @Override
  public RamlTypeBase getOwnersType() {
    return _owner;
  }
